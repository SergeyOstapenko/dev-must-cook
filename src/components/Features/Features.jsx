    ...
    <div className="container">
      <ul className={styled.features_list}>
        <li className={styled.features_item}>
          <div className={styled.features_icon}><FaPencilAlt color="white" size={24}/></div>
          <p className={styled.features_text}>Щоденне оновлення рецептів</p>
        </li>
        <li className={styled.features_item}>
          <div className={styled.features_icon}><FaRoute color="white" size={24}/></div>
          <p className={styled.features_text}>Безкоштовна доставка в будь яку точку міста</p>
        </li>
        <li className={styled.features_item}>
          <div className={styled.features_icon}><FaGlobeEurope color="white" size={24}/></div>
